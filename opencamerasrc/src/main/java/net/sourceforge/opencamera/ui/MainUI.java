...
public class MainUI {
    ...
    private final MainCameraActivity main_activity;
    ...
    public MainUI(MainCameraActivity main_activity) {
        if( MyDebug.LOG )
            Log.d(TAG, "MainUI");
    ...
    private void layoutUI(boolean popup_container_only) {
        ...
        if( !popup_container_only )
        {
            ...
            view = main_activity.findViewById(R.id.cycle_flash);
            setViewRotation(view, ui_rotation);
        ...
        main_activity.runOnUiThread(new Runnable() {
            public void run() {
                ...
                if( main_activity.showSwitchMultiCamIcon() )
                    switchMultiCameraButton.setVisibility(View.GONE);//update by widy//switchMultiCameraButton.setVisibility(visibility);
                switchVideoButton.setVisibility(enableVideo?View.VISIBLE:View.GONE);//update by widy //switchVideoButton.setVisibility(visibility);
                if( main_activity.supportsExposureButton() )
                    exposureButton.setVisibility(View.GONE); //update by widy exposureButton.setVisibility(visibility);
                ...
                settingsButton.setVisibility(View.GONE); //update by widy
                if( MyDebug.LOG ) {
    ...
    public void showGUI() {
        ...
        main_activity.runOnUiThread(new Runnable() {
            public void run() {
                ...
                switchVideoButton.setVisibility(enableVideo?View.VISIBLE:View.GONE);//update by widy //switchVideoButton.setVisibility(visibility);
                if( main_activity.supportsExposureButton() )
                    exposureButton.setVisibility(View.GONE);//update by widy //exposureButton.setVisibility(visibility_video); // still allow exposure when recording video
                if( showExposureLockIcon() )
                ...
                //update by widy
                popupButton.setVisibility(View.GONE);//popupButton.setVisibility(main_activity.getPreview().supportsFlash() ? visibility_video : visibility); // still allow popup in order to change flash mode when recording video
