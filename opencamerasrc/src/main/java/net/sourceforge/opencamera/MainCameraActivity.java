...
import net.sourceforge.opencamera.minigallery.FileType;
import net.sourceforge.opencamera.minigallery.GalleryAdapter;
...
public class MainCameraActivity extends Activity {
    ...
    private static final int RQ_GALLERY = 90;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( getIntent() != null && getIntent().getExtras() != null ) {
            if(getIntent().getExtras().getString("KTP_MODE")!=null){
                ImageView imgMode = findViewById(R.id.img_mode);
                LinearLayout llInfo = findViewById(R.id.ll_info);
                TextView tvHeader = findViewById(R.id.tv_header);
                TextView tvDetail = findViewById(R.id.tv_detail);
                imgMode.setVisibility(View.VISIBLE);
                llInfo.setVisibility(View.VISIBLE);
                if(getIntent().getExtras().getString("KTP_MODE").equals("KTP_ONLY")){
                    imgMode.setImageDrawable(getApplicationContext().getResources().getDrawable(R.drawable.ic_ktp_only));
                    tvHeader.setText(getString(R.string.foto_identitas));
                    tvDetail.setText(getString(R.string.detail_identitas));
                }else if(getIntent().getExtras().getString("KTP_MODE").equals("KTP_SELFIE")){
                    imgMode.setImageDrawable(getApplicationContext().getResources().getDrawable(R.drawable.ic_ktp_selfie));
                    tvHeader.setText(getString(R.string.selfie_identitas));
                    tvDetail.setText(getString(R.string.detail_selfie));
                }
            }else {
                setRvGallery();
                setMiniGallery();
        ...
        setDefault(sharedPreferences); //update by widy
        if( MyDebug.LOG )
        ...
        switchCameraButton.setVisibility(View.GONE);// update by widyswitchCameraButton.setVisibility(n_cameras > 1 ? View.VISIBLE : View.GONE);
        ...
        orientationEventListener = new OrientationEventListener(this) {
            ...
            public void onOrientationChanged(int orientation) {
                MainCameraActivity.this.mainUI.onOrientationChanged(orientation);
            }
        };
        if( MyDebug.LOG )
        ...
        decorView.setOnSystemUiVisibilityChangeListener
                (new View.OnSystemUiVisibilityChangeListener() {
                    ...
                    public void onSystemUiVisibilityChange(int visibility) {
                        ...
                        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(MainCameraActivity.this);
        ...
        new Thread(new Runnable() {
            public void run() {
                textToSpeech = new TextToSpeech(MainCameraActivity.this, new TextToSpeech.OnInitListener() {
                    @Override
    ...
    private void setDefault(SharedPreferences sharedPreferences){
        sharedPreferences.edit().putString(PreferenceKeys.getResolutionPreferenceKey(0), "1280 720").apply();
        sharedPreferences.edit().putString(PreferenceKeys.getResolutionPreferenceKey(1), "640 480").apply();
        sharedPreferences.edit().putString(PreferenceKeys.getVideoQualityPreferenceKey(this.preview.getCameraId(), this.preview.fpsIsHighSpeed(applicationInterface.getVideoFPSPref())), "3_r640x480").apply();
        sharedPreferences.edit().putString(PreferenceKeys.VideoMaxDurationPreferenceKey,"10").apply();
        sharedPreferences.edit().putString(PreferenceKeys.QualityPreferenceKey, "40").apply();
        sharedPreferences.edit().putBoolean(PreferenceKeys.ShowZoomSliderControlsPreferenceKey, false).apply();
        sharedPreferences.edit().putBoolean(PreferenceKeys.ShowBatteryPreferenceKey, false).apply();
        sharedPreferences.edit().putBoolean(PreferenceKeys.ShowTimePreferenceKey, false).apply();
        sharedPreferences.edit().putBoolean(PreferenceKeys.ShowFreeMemoryPreferenceKey, false).apply();
        sharedPreferences.edit().putBoolean(PreferenceKeys.ThumbnailAnimationPreferenceKey, false).apply();
        sharedPreferences.edit().putBoolean(PreferenceKeys.ShowCycleFlashPreferenceKey, true).apply();
        sharedPreferences.edit().putBoolean(PreferenceKeys.ShowWhiteBalanceLockPreferenceKey, false).apply();
        sharedPreferences.edit().putBoolean(PreferenceKeys.ShowExposureLockPreferenceKey, false).apply();
        sharedPreferences.edit().putBoolean(PreferenceKeys.ShowZoomControlsPreferenceKey, false).apply();
        sharedPreferences.edit().putBoolean(PreferenceKeys.ShowZoomPreferenceKey, false).apply();
        sharedPreferences.edit().putString(PreferenceKeys.PreviewSizePreferenceKey, "preference_preview_size_display").apply();
    ...
    private final BroadcastReceiver cameraReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            MainCameraActivity.this.takePicture(false);
        }
    };
    ...
    public void updateGalleryIcon() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                ...
                KeyguardManager keyguard_manager = (KeyguardManager) MainCameraActivity.this.getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static class MyFolderChooserDialog extends FolderChooserDialog {
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            MainCameraActivity main_activity = (MainCameraActivity)this.getActivity();
    ...
    private class MyGestureDetector extends SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            try {
                ...
                final ViewConfiguration vc = ViewConfiguration.get(MainCameraActivity.this);
    ...
    void cameraSetup() {
        ...
        exposureButton.setVisibility(View.GONE); //update by widy//exposureButton.setVisibility(supportsExposureButton() && !mainUI.inImmersiveMode() ? View.VISIBLE : View.GONE);
    ...
    private void setMiniGallery(){
        ...
        if (cursor != null) {
            String[] proj = { MediaStore.Images.Media.DATA, MediaStore.Video.VideoColumns.DATA };
            int count = 0;
            while (cursor.moveToNext() && count < 40) {
                String imageLocation = "";
                for (String s : proj) {
                    if(!imageLocation.equals(cursor.getString(cursor.getColumnIndex(s)))) {
                        int type = cursor.getInt(cursor.getColumnIndex(MediaStore.Files.FileColumns.MEDIA_TYPE));
                        imageLocation = cursor.getString(cursor.getColumnIndex(s));
                        File imageFile = new File(imageLocation);
                        if(type == MediaStore.Files.FileColumns.MEDIA_TYPE_IMAGE) {
                            fileTypes.add(new FileType(type, Uri.fromFile(imageFile)));
        ...
        fileTypes.add(new FileType(-1, null));
        galleryAdapter.notifyDataSetChanged();
    }

    private void setRvGallery(){
        galleryAdapter = new GalleryAdapter(getApplicationContext(), fileTypes);
        ...
        galleryAdapter.setOnItemClickListener(new GalleryAdapter.OnItemClickListener() {
            @Override
            public void onImageClick(FileType fileType, int pos) {
                setResult(fileType.getUri(), "IMAGE");
            }
            ...
            public void onMoreImageClick() {
                ...
                startActivityForResult(chooseFile, RQ_GALLERY);
            }
        });
    }

    private void setResult(Uri uri, String type){
        Intent output = new Intent();
        output.putExtra("image_or_video", type);
        output.setData(uri);
