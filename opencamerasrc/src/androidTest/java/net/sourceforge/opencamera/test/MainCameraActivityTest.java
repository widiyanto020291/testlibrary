...
public class MainCameraActivityTest extends ActivityInstrumentationTestCase2<MainCameraActivity> {
    private static final String TAG = "MainActivityTest";
    private MainCameraActivity mActivity = null;
    ...
    public MainCameraActivityTest() {
        super("net.sourceforge.opencamera", MainCameraActivity.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        MainCameraActivity.test_preview_want_no_limits = false;
        MainCameraActivity.test_preview_want_no_limits_value = false;
        ...
        editor.clear();
        if( test_camera2 ) {
            MainCameraActivity.test_force_supports_camera2 = true;
    ...
    public void testAutoFocus() throws InterruptedException {
        ...
        TouchUtils.clickView(MainCameraActivityTest.this, mPreview.getView());
    ...
    public void testAutoFocusCorners() {
        ...
        Log.d(TAG, "top-left");
        TouchUtils.drag(MainCameraActivityTest.this, gui_location[0] + step_dist_c, gui_location[0], gui_location[1] + step_dist_c, gui_location[1], step_count_c);
        assertTrue(mPreview.hasFocusArea());
        assertNotNull(mPreview.getCameraController().getFocusAreas());
        assertEquals(1, mPreview.getCameraController().getFocusAreas().size());
        assertNotNull(mPreview.getCameraController().getMeteringAreas());
        ...
        Log.d(TAG, "top-right");
        TouchUtils.drag(MainCameraActivityTest.this, gui_location[0]+width-1-large_step_dist_c, gui_location[0]+width-1, gui_location[1]+large_step_dist_c, gui_location[1], step_count_c);
        assertFalse(mPreview.hasFocusArea());
        assertNull(mPreview.getCameraController().getFocusAreas());
        assertNull(mPreview.getCameraController().getMeteringAreas());

        Log.d(TAG, "bottom-left");
        TouchUtils.drag(MainCameraActivityTest.this, gui_location[0]+step_dist_c, gui_location[0], gui_location[1]+height-1-step_dist_c, gui_location[1]+height-1, step_count_c);
        assertTrue(mPreview.hasFocusArea());
        assertNotNull(mPreview.getCameraController().getFocusAreas());
        assertEquals(1, mPreview.getCameraController().getFocusAreas().size());
        assertNotNull(mPreview.getCameraController().getMeteringAreas());
    ...
    private void subTestTouchToFocus(final boolean wait_after_focus, final boolean single_tap_photo, final boolean double_tap_photo, final boolean manual_can_auto_focus, final boolean can_focus_area, final String focus_value, final String focus_value_ui) throws InterruptedException {
        ...
        Log.d(TAG, "about to click preview for autofocus");
        if( double_tap_photo ) {
            TouchUtils.tapView(MainCameraActivityTest.this, mPreview.getView());
        }
        else {
            TouchUtils.clickView(MainCameraActivityTest.this, mPreview.getView());
        }
    ...
    public void testLayoutNoLimits() throws InterruptedException {
        ...
        MainCameraActivity.test_preview_want_no_limits = true;
        MainCameraActivity.test_preview_want_no_limits_value = false;
        ...
        MainCameraActivity.test_preview_want_no_limits_value = true;
        updateForSettings();
        Thread.sleep(1000);
