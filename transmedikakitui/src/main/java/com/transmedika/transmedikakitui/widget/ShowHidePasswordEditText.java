...
public class ShowHidePasswordEditText extends androidx.appcompat.widget.AppCompatEditText {
    ...
    private void init(Context ctx, AttributeSet attrs) {
        if (attrs != null) {
            ...
            visibilityIndicatorShow = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_show, R.drawable.ic_visibility_off_24dp);
            visibilityIndicatorHide = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_hide, R.drawable.ic_visibility_24dp);
            ...
            String customFont = attrsArray.getString(R.styleable.ShowHidePasswordEditText_customFont);
            setCustomFont(ctx, customFont);

            attrsArray.recycle();
        } else {
            visibilityIndicatorShow = R.drawable.ic_visibility_off_24dp;
            visibilityIndicatorHide = R.drawable.ic_visibility_24dp;
