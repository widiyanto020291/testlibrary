...
public class BasePage<T> {
    @SerializedName("current_page") private Integer page;
    @SerializedName("data") private T data;
    @SerializedName("first_page_url") private String firstPageUrl;
    @SerializedName("from") private Integer from;
    @SerializedName("last_page") private Integer lastPage;
    @SerializedName("last_page_url") private String lastPageUrl;
    ...
    @SerializedName("to")private Integer to;
